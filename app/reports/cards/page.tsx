...
export default function CardsPage() {
  ...
  const done = mockStudents.filter((s) => s.reportCardDone).length;
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl bg-white border border-slate-100 shadow-sm p-5">
        <div className="flex items-center justify-between mb-3">
          <p className="text-sm font-medium text-slate-700">درصد تکمیل کارنامه‌ها</p>
        ...
        <div className="overflow-x-auto">
          <table className="w-full min-w-[550px] text-sm">
            ...
            <tbody className="divide-y divide-slate-50">
              {mockStudents
                .sort((a, b) => Number(a.reportCardDone) - Number(b.reportCardDone))
                .map((s) => (
